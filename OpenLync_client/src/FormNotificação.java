...
public class FormNotificação extends JFrame {
	...
	public void setFotoUsuarios(BufferedImage foto) {
		this.fotoUsuario = foto;
	}
	
	public void setIndexFrameUsuario(int index) {
		this.indexFrameUsuario = index;
	}

	/**
	 * Atualiza componentes;
	 * Apos 7s o form é fechado
	 */
	@Override
	public void setVisible(boolean b) {
		
		labelFoto.setIcon(new ImageIcon(fotoUsuario));
		labelMensagem.setText("Nova mensagem de " + nomeUsuario + "...");
