...
public class Criptografia {
	...
	public String criptografarMensagem(String mensagem) {
        ...
        for (int i=0; i < mensagem.length(); i++){    	// Vare linha
            ...
            int letraCript = (((x*8) +3) *39);  		// Realiza calculo de criptografia
	...
	public String descriptografarMensagem(String mensagem) {
		...
		for (int z=0; z < mensagem.length(); z++) {    	// Varre da linha
            ...
            int contador = (z + 5);                 	// Seta tamanho do codigo asc a ser descript.
            for (int i=z; i<contador; i++) {        	// Captura numero asc a ser calculado          
            ...
            int asc = (((Integer.parseInt(carac) /39) -3) /8);	// Calculo inverso de descriptografia
